scoreboard players set O0 objectiveMList 0
scoreboard players remove @s objectiveMC 1

execute at @s run playsound minecraft:entity.player.levelup player @s ~ ~ ~ 1 1.5

execute if score @s objectiveM1 matches 0 run scoreboard players reset @s objectiveM1
execute if score @s objectiveM2 matches 0 run scoreboard players reset @s objectiveM2
execute if score @s objectiveM3 matches 0 run scoreboard players reset @s objectiveM3
execute if score @s objectiveM4 matches 0 run scoreboard players reset @s objectiveM4
execute if score @s objectiveM5 matches 0 run scoreboard players reset @s objectiveM5
execute if score @s objectiveM6 matches 0 run scoreboard players reset @s objectiveM6
execute if score @s objectiveM7 matches 0 run scoreboard players reset @s objectiveM7
execute if score @s objectiveM8 matches 0 run scoreboard players reset @s objectiveM8
execute if score @s objectiveM9 matches 0 run scoreboard players reset @s objectiveM9
execute if score @s objectiveM10 matches 0 run scoreboard players reset @s objectiveM10
...
tellraw @s ["",{"text":"\n "},{"text":"Objective Complete:","bold":true,"color":"aqua"},{"text":"\n"},{"text":"- Shoot yourself with a Guava Grenade","strikethrough":true,"color":"yellow"}]
