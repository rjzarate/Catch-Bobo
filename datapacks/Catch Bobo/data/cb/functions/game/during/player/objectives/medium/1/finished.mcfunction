scoreboard players set O1 objectiveMList 0
...
execute if score @s objectiveM1 matches 1 run scoreboard players reset @s objectiveM1
execute if score @s objectiveM2 matches 1 run scoreboard players reset @s objectiveM2
execute if score @s objectiveM3 matches 1 run scoreboard players reset @s objectiveM3
execute if score @s objectiveM4 matches 1 run scoreboard players reset @s objectiveM4
execute if score @s objectiveM5 matches 1 run scoreboard players reset @s objectiveM5
execute if score @s objectiveM6 matches 1 run scoreboard players reset @s objectiveM6
execute if score @s objectiveM7 matches 1 run scoreboard players reset @s objectiveM7
execute if score @s objectiveM8 matches 1 run scoreboard players reset @s objectiveM8
execute if score @s objectiveM9 matches 1 run scoreboard players reset @s objectiveM9
execute if score @s objectiveM10 matches 1 run scoreboard players reset @s objectiveM10
...
tellraw @s ["",{"text":"\n "},{"text":"Objective Complete:","bold":true,"color":"aqua"},{"text":"\n"},{"text":"- Run Away from Sans","strikethrough":true,"color":"yellow"}]
