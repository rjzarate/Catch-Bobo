...
execute if score @s yongpyoCD matches 120.. if score @s yongpyo matches ..0 run attribute @s minecraft:generic.attack_speed base set 4.25
execute if score @s yongpyoCD matches 120.. if score @s yongpyo matches ..0 run attribute @s minecraft:generic.attack_damage base set 1
execute if score @s yongpyoCD matches 120.. if score @s yongpyo matches ..0 run attribute @s minecraft:generic.movement_speed base set 0.110000001639127732
execute if score @s yeouiCD matches ..10 run scoreboard players set @s yeouiCD 15
...
execute at @s run playsound minecraft:item.armor.equip_gold player @a ~ ~ ~ 2 0