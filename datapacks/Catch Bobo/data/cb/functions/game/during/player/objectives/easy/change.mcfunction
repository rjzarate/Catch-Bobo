...
execute if score constant sNotifyHO matches 2 run tellraw @a[team=Hunters,gamemode=!spectator] ["",{"text":"Bobo ","bold":true,"color":"gold"},{"text":"completed a set of ","color":"aqua"},{"text":"Easy Objectives","bold":true,"color":"green"},{"text":"!","color":"aqua"}]
...
execute if score constant sNotifyHO matches 3 run tellraw @a[team=Hunters,gamemode=!spectator] ["",{"text":"Bobo ","bold":true,"color":"gold"},{"text":"completed a set of ","color":"aqua"},{"text":"Easy Objectives","bold":true,"color":"green"},{"text":"!","color":"aqua"}]
