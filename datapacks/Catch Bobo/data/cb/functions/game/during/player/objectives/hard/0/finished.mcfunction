scoreboard players set O0 objectiveHList 0
scoreboard players remove @s objectiveHC 1

execute at @s run playsound minecraft:entity.player.levelup player @s ~ ~ ~ 1 1.5

execute if score @s objectiveH1 matches 0 run scoreboard players reset @s objectiveH1
execute if score @s objectiveH2 matches 0 run scoreboard players reset @s objectiveH2
execute if score @s objectiveH3 matches 0 run scoreboard players reset @s objectiveH3
execute if score @s objectiveH4 matches 0 run scoreboard players reset @s objectiveH4
execute if score @s objectiveH5 matches 0 run scoreboard players reset @s objectiveH5
...
tellraw @s ["",{"text":"\n "},{"text":"Objective Complete:","bold":true,"color":"aqua"},{"text":"\n"},{"text":"- Activate Starfruit Swapper","strikethrough":true,"color":"red"}]
