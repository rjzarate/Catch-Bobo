...
effect clear @a[team=Bobo,tag=!bobo]
...
execute as @a[team=Bobo,tag=!bobo] run attribute @s minecraft:generic.movement_speed base set 0.05000000074505806
effect give @a[team=Bobo,tag=!bobo] minecraft:instant_health 1 0 true
effect give @a[team=Bobo,tag=!bobo] minecraft:glowing 10 0 true
