...
execute if entity @s[tag=!timeStoppee,tag=!displayOnly,tag=!adwared] run function orangutan:impostor/cooldown
...
execute if entity @s[advancements={orangutan:impostor=true},tag=!timeStoppee,tag=!displayOnly] if score .rightClick enderEye matches 0 run function orangutan:impostor/ability_directory
