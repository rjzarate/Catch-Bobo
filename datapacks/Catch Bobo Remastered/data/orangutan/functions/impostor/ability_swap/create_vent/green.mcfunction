...
execute unless score @s createVentCD matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'[{"text":"Build ","color":"gold","bold":true,"italic":false},{"text":"Green ","color":"green"},{"text":"Vent","color":"gold"}]'},Tags:["impostor","createVent","createGreenVent","ventCooldownIncrease","activationRequirement","onGround","ventHealth","ventLifespan","uponDrop","cooldown","actionbarRegular"],createGreenVent:1,ventCooldownIncrease:15,ventHealth:10,ventLifespan:450,cooldown:8,CustomModelData:106} 1
execute if score @s createVentCD matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'[{"text":"Build ","color":"gold","bold":true,"italic":false},{"text":"Green ","color":"green"},{"text":"Vent","color":"gold"}]'},Tags:["impostor","createVent","createGreenVent","ventCooldownIncrease","activationRequirement","onGround","ventHealth","ventLifespan","uponDrop","cooldown","actionbarRegular"],createGreenVent:1,ventCooldownIncrease:15,ventHealth:10,ventLifespan:450,cooldown:8,CustomModelData:1000106} 1
