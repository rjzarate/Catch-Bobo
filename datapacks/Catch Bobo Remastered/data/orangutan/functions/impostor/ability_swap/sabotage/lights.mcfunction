...
execute unless score @s sabotageCD matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Sabotage Lights","color":"gold","bold":true,"italic":false}'},Enchantments:[{}],Tags:["impostor","sabotage","sabotageLights","duration","chargeUp","darkness","chargeUpRequirement","twoHuntersAlive","aliveOcelot","ocelot","ocelotHealth","ocelotSpeed","ocelotLifespan","cooldown","uponDrop","actionbarChargeUpDuration"],sabotageO2:1,duration:10,chargeUp:50,darkness:10,ocelotHealth:20,ocelotSpeed:75,ocelotLifespan:50,cooldown:120,CustomModelData:109} 1
execute if score @s sabotageCD matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Sabotage Lights","color":"gold","bold":true,"italic":false}'},Enchantments:[{}],Tags:["impostor","sabotage","sabotageLights","duration","chargeUp","darkness","chargeUpRequirement","twoHuntersAlive","aliveOcelot","ocelot","ocelotHealth","ocelotSpeed","ocelotLifespan","cooldown","uponDrop","actionbarChargeUpDuration"],sabotageO2:1,duration:10,chargeUp:50,darkness:10,ocelotHealth:20,ocelotSpeed:75,ocelotLifespan:50,cooldown:120,CustomModelData:1000109} 1
