...
title @a[team=Hunters,gamemode=!spectator] title ["",{"text":"REACTOR MELTDOWN","bold":true,"italic":false,"color":"red"}]
title @a[team=Hunters,gamemode=!spectator] subtitle ["",{"text":"Kill both red ocelots to fix reactor.","bold":false,"italic":true,"color":"white"}]
tellraw @a[team=Hunters,gamemode=!spectator] ["",{"text":"REACTOR MELTDOWN\n","bold":true,"italic":false,"color":"red"},{"text":"Kill both red ocelots to fix reactor.\nFailure grants ","bold":false,"italic":true,"color":"white"},{"text":"Bobo","bold":true,"italic":true,"color":"gold"},{"text":" a fruit.","bold":false,"italic":true,"color":"white"}] 
