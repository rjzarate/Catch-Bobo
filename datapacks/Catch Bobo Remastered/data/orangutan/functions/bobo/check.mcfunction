...
execute if entity @s[tag=!timeStoppee,tag=!displayOnly,tag=!adwared] run function orangutan:bobo/cooldown
...
execute if entity @s[advancements={orangutan:bobo=true},tag=!timeStoppee,tag=!displayOnly] if score .rightClick enderEye matches 0 run function orangutan:bobo/ability_directory
...
execute if score @s[tag=!timeStoppee] blindingBlueberryDuration matches 1.. run function orangutan:bobo/blinding_blueberry/active
execute if score @s[tag=!timeStoppee] durianDecoyDuration matches 1.. run function orangutan:bobo/durian_decoy/active
