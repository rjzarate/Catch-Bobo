...
execute if score @s starfruitSwapperTangerineTeleporter matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Starfruit Swapper","color":"gold","bold":true,"italic":false}'},Tags:["bobo","starfruitSwapper","hunterEffects","resistance2","fireResistance","activationRequirement","onGround","onLava","uponDrop","killCooldown","actionbarOnDeath"],CustomModelData:6,starfruitSwapper:1,resistance2:4,fireResistance:8} 1
execute unless score @s starfruitSwapperTangerineTeleporter matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Starfruit Swapper","color":"gold","bold":true,"italic":false}'},Tags:["bobo","starfruitSwapper","hunterEffects","resistance2","fireResistance","activationRequirement","onGround","onLava","uponDrop","killCooldown","actionbarOnDeath"],CustomModelData:1000006,starfruitSwapper:1,resistance2:4,fireResistance:8} 1
