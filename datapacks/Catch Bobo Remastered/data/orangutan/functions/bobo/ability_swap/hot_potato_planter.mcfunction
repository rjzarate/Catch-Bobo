...
execute if score @s guavaGrenadeHotPotatoPlanterAmmo matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Hot Potato Planter","color":"gold","bold":true,"italic":false}'},Enchantments:[{}],Tags:["bobo","hotPotatoPlanter","explosion","fuse","ammo","maxAmmo","lifespan","uponDrop","cooldown","ammoCooldown","actionbarAmmo1"],CustomModelData:5,hotPotatoPlanter:1,explosion:3,fuse:50,maxAmmo:3,lifespan:600,cooldown:50,ammoCooldown:1} 1
execute unless score @s guavaGrenadeHotPotatoPlanterAmmo matches 1.. run item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Hot Potato Planter","color":"gold","bold":true,"italic":false}'},Enchantments:[{}],Tags:["bobo","hotPotatoPlanter","explosion","fuse","ammo","maxAmmo","lifespan","uponDrop","cooldown","ammoCooldown","actionbarAmmo1"],CustomModelData:1000005,hotPotatoPlanter:1,explosion:3,fuse:50,maxAmmo:3,lifespan:600,cooldown:50,ammoCooldown:1} 1
