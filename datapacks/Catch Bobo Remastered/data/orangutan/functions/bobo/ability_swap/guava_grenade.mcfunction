...
execute if score @s guavaGrenadeHotPotatoPlanterAmmo matches 1.. anchored eyes run particle minecraft:item minecraft:ender_eye{CustomModelData:5} ^ ^-0.5 ^0.4 0.25 0.15 0.25 0 10 normal
execute unless score @s guavaGrenadeHotPotatoPlanterAmmo matches 1.. anchored eyes run particle minecraft:item minecraft:ender_eye{CustomModelData:1000005} ^ ^-0.5 ^0.4 0.25 0.15 0.25 0 10 normal
