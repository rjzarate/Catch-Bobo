...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Durian Decoy","color":"gold","bold":true,"italic":false}'},Enchantments:[{}],Tags:["bobo","duration","durianDecoy","invisibility","speed5","weakness100","removesGlowing","decoy","uponDrop","cooldown","actionbarDuration"],CustomModelData:3,duration:5,invisibility:5,speed5:5,weakness100:5,duration:5,decoy:10,decoySlowness5:3,cooldown:100} 1
...
execute anchored eyes run particle minecraft:item minecraft:ender_eye{CustomModelData:2} ^ ^-0.5 ^0.4 0.25 0.15 0.25 0 10 normal
