...
execute as @e[tag=hunter,type=#general:hunters,tag=inRange] run scoreboard players operation @s blindness = @s blindness
execute as @e[tag=hunter,type=#general:hunters,tag=inRange] run scoreboard players operation @s slowness1 = @s slowness1
execute as @e[tag=hunter,type=#general:hunters,tag=inRange] if score @s blindness < .blindness stats run scoreboard players operation @s blindness += .blindness stats
execute as @e[tag=hunter,type=#general:hunters,tag=inRange] if score @s slowness1 < .slowness1 stats run scoreboard players operation @s slowness1 += .slowness1 stats
