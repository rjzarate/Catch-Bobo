execute as @a[team=Hunters,gamemode=!spectator] at @s unless score @s hotPotatoDropped matches 1.. run summon minecraft:creeper ~ ~ ~ {Team:"OrangutansAlt",ExplosionRadius:2b,Fuse:0,CustomName:'{"text":"Hot Potato","color":"gold","bold":true,"italic":false}'}
