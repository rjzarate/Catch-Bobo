...
execute if score @s guavaGrenadeFuse matches ..0 at @s run summon minecraft:creeper ~ ~0.25 ~ {Team:"OrangutansAlt",ExplosionRadius:3b,Fuse:0,CustomName:'{"text":"Guava Grenade","color":"gold","bold":true,"italic":false}'}
