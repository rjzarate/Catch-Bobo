...
execute if score @s blindingDartCD matches ..0 run function orangutan:teemo/zrefresh/blinding_dart

execute if score @s moveQuickCD matches ..0 run function orangutan:teemo/zrefresh/move_quick

execute if score @s noxiousTrapCD matches ..0 run function orangutan:teemo/zrefresh/noxious_trap
...
execute if score @s recallCD matches ..0 run function orangutan:teemo/zrefresh/recall