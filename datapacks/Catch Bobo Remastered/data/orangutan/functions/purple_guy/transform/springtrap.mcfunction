...
#armor
	...
	item replace entity @s armor.feet with leather_boots{display:{Name:'{"text":"Springlock Suit","color":"gold","bold":true,"italic":false}',color:3354646},Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:feather_falling",lvl:3s}],AttributeModifiers:[{AttributeName:"generic.max_health",Name:"generic.max_health",Amount:0,Operation:0,UUID:[I;1234567890,-1234567890,1234567890,-123456789]}],HideFlags:71,Unbreakable:1b,purpleGuy:1} 1
