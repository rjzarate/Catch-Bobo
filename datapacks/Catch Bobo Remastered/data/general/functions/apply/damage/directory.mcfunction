...
execute at @s facing entity @p[tag=shot] eyes positioned ^ ^ ^10 run summon minecraft:bat ~ 400 ~ {Silent:1b,PersistenceRequired:1b,NoAI:1b,Health:1f,Tags:["temp","new"],CustomName:'{"text":"Filler"}',ArmorItems:[{},{},{},{id:"minecraft:leather_helmet",Count:1b,tag:{Enchantments:[{id:"minecraft:thorns",lvl:0s}]}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],active_effects:[{id:"minecraft:wither",amplifier:0b,duration:60,show_particles:0b}]}
#damage temp scoreboard
scoreboard players add #damage temp 10
#damage temp to thorns
execute at @s facing entity @p[tag=shot] eyes positioned ^ ^ ^10 positioned ~ 400 ~ store result entity @e[type=minecraft:bat,tag=temp,tag=new,sort=nearest,limit=1] ArmorItems[{id:"minecraft:leather_helmet"}].tag.Enchantments.[{id:"minecraft:thorns"}].lvl short 1 run scoreboard players get #damage temp
...
execute at @s facing entity @p[tag=shot] eyes positioned ^ ^ ^10 positioned ~ 400 ~ run data modify entity @e[type=minecraft:bat,tag=temp,tag=new,sort=nearest,limit=1] CustomName set from block 0 1 0 Text1
...
summon minecraft:bat ~ 450 ~ {Silent:1b,PersistenceRequired:1b,NoAI:1b,Health:1f,Tags:["temp","new","player"],CustomName:'{"text":"Filler"}',ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{id:"minecraft:leather_leggings",Count:1b},{id:"minecraft:leather_chestplate",Count:1b},{id:"minecraft:leather_helmet",Count:1b}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],active_effects:[{id:"minecraft:wither",amplifier:0b,duration:60,show_particles:0b}]}
