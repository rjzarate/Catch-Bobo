execute if entity @s[tag=!timeStoppee,tag=!impostorStun] run function hunter:boba_fett/cooldown
...
execute if entity @s[advancements={hunter:boba_fett=true},tag=!timeStoppee,tag=!impostorStun] if score .rightClick enderEye matches 0 run function hunter:boba_fett/ability_directory
#auto ender eye for ee-3 and flamethrower
execute if entity @s[advancements={hunter:boba_fett=true},tag=!timeStoppee,tag=!impostorStun] if predicate hunter:boba_fett/auto run function hunter:boba_fett/ability_directory1
...
execute if score @s[tag=!timeStoppee,tag=!impostorStun] jetpackFuelAmmo matches 1.. if score #hasJetpackFuel temp matches 0 run function hunter:boba_fett/jetpack_fuel/give

#elytra
execute if predicate general:fall_flying if entity @s[tag=!timeStoppee,tag=!impostorStun] run function hunter:boba_fett/jetpack_fuel/flying
execute unless predicate general:fall_flying if entity @s[tag=!timeStoppee,tag=!impostorStun] run function hunter:boba_fett/jetpack_fuel/not_flying
