...
execute if predicate hunter:jotaro/ora if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s oraDuration
...
execute if predicate hunter:guts/indomitable_will if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s indomitableWillDuration
...
execute if predicate hunter:guts/berserker_armor if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s berserkerArmorDuration
...
execute if predicate hunter:pepsi_man/pepsi_splash if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s pepsiSplashDuration
...
execute if predicate hunter:mori/geundoowun if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s geundoowunDuration
...
execute if predicate hunter:mori/thunder_breaker if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s thunderBreakerDuration
...
execute if predicate hunter:mori/yongpyo if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s yongpyoDuration
...
execute if predicate hunter:officer/orangutan_cloth if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s orangutanClothDuration
...
execute if predicate hunter:officer/dog_whistle if score duration actionbarCD matches 1.. run scoreboard players operation int actionbarCD = @s dogWhistleDuration
