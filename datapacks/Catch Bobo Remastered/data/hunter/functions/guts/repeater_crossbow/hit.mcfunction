...
tag @a[team=Hunters,tag=guts,predicate=general:uuid_search] add shot

#visuals and audio
execute as @a[team=Hunters,tag=guts,gamemode=!spectator,tag=shot] at @s run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
