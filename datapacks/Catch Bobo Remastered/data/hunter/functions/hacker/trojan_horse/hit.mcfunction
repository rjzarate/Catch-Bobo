...
execute as @a[team=Hunters,tag=hacker,gamemode=!spectator,predicate=general:uuid_search,limit=1] run tag @s add shot

#visuals and audio
execute as @a[team=Hunters,tag=hacker,gamemode=!spectator,tag=shot] at @s run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
