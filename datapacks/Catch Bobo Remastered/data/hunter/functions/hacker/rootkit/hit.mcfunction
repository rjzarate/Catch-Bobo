...
summon minecraft:area_effect_cloud ^ ^ ^ {Tags:["rootkit","timeStoppable"],Duration:20000}
summon minecraft:armor_stand ^ ^-0.5 ^ {Tags:["rootkit","timeStoppable"],Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:beetroot",Count:1b}],Pose:{Head:[0f,1f,0f]}}
...
execute rotated as @s run tp @e[type=minecraft:area_effect_cloud,tag=rootkit,tag=!finished,limit=1,sort=nearest] ~ ~ ~ ~ ~
execute rotated as @s run tp @e[type=minecraft:armor_stand,tag=rootkit,tag=!finished,limit=1,sort=nearest] ~ ~ ~ ~ 0
