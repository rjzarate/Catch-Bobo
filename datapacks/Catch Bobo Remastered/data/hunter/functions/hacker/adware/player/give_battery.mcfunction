#gives battery to player
	execute as @p[tag=hunter,tag=hacker,gamemode=!spectator,predicate=general:uuid_search] unless score @s battery matches 2001.. run scoreboard players add @s battery 3
