...
execute if entity @s[tag=!timeStoppee,tag=!impostorStun] run function hunter:officer/cooldown
...
execute if entity @s[advancements={hunter:officer=true},tag=!timeStoppee,tag=!impostorStun] if score .rightClick enderEye matches 0 run function hunter:officer/ability_directory
