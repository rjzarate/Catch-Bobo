...
execute if predicate hunter:pepsi_man/pepsi_creation if score @s pepsiCreationAmmo matches 1.. at @s if entity @a[tag=hunter,gamemode=!spectator,distance=..20,tag=!hasPepsiCan] run function hunter:pepsi_man/pepsi_creation/activate