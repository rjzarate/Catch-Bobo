#store the effect in a storage, amplifier = stacks of overloadedBrewing; duration = effect duration
data modify storage minecraft:unluck Unluck set from entity @s ActiveEffects[{Id:27}]
execute store result score .stacks vaccinatorEffect run data get storage minecraft:unluck Unluck.Amplifier
execute store result score .percentage vaccinatorEffect run data get storage minecraft:unluck Unluck.Duration
scoreboard players remove .stacks vaccinatorEffect 100
