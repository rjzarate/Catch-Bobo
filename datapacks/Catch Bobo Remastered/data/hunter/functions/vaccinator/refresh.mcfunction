...
execute if score @s selfDiagnoseCD matches ..0 run function hunter:vaccinator/zrefresh/self_diagnose

execute if score @s unstableConcoctionCD matches ..0 run function hunter:vaccinator/zrefresh/unstable_concoction