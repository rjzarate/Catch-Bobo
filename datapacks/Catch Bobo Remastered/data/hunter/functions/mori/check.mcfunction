...
execute if entity @s[advancements={hunter:mori=true},tag=!timeStoppee,tag=!impostorStun,tag=!displayOnly] if score .rightClick enderEye matches 0 run function hunter:mori/ability_directory
