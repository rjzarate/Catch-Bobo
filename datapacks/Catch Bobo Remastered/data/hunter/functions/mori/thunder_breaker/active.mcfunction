#creates shulker
execute unless predicate general:is_sneaking at @s positioned ~ ~-1.1 ~ unless entity @e[type=minecraft:shulker,distance=..0.8] if block ~ ~ ~ #general:dashables run summon minecraft:shulker ~ ~ ~ {Silent:1b,PersistenceRequired:1b,NoAI:1b,AttachFace:0b,Color:0b,Health:0.01f,Tags:["timeStoppable","thunderBreaker"]}
