...
scoreboard players operation @s starPlatinumPunchDuration = .successfulHitDuration stats

attribute @s minecraft:generic.attack_speed modifier add 1-0-0-0-1 jotaro_punch 1 add
...
advancement revoke @s only hunter:jotaro/damage_punch