...
#makes bobo glow if he isn't glowing already and is not in decoy mode
	execute if score .endGlowing gameStats matches 1 as @a[team=Orangutans,tag=bobo,gamemode=!spectator] unless score @s glowing matches 2.. run scoreboard players set @s glowing 2
