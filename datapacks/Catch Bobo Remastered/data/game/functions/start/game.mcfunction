...
tellraw @a[tag=hunter] [{"text":"Main Objective: ","color":"light_purple"},{"text":"Kill ","color":"red"},{"text":"Bobo","bold":true,"color":"gold"},{"text":".","color":"aqua"}]
	...
	execute if score .endGlowing gameStats matches 0 run tellraw @a[tag=hunter] [{"text":" "},{"text":"Bobo","bold":true,"color":"gold"},{"text":"will ","color":"aqua"},{"text":"NOT glow","color":"light_purple"},{"text":" when they collect ","color":"aqua"},{"text":"fruits","color":"light_purple"},{"text":". Be on the lookout!","color":"aqua"}]
	execute if score .endGlowing gameStats matches 1 run tellraw @a[tag=hunter] [{"text":" "},{"text":"Bobo","bold":true,"color":"gold"},{"text":"will ","color":"aqua"},{"text":"glow","color":"light_purple"},{"text":" when they collect ","color":"aqua"},{"text":"fruits","color":"light_purple"},{"text":". Be on the lookout!","color":"aqua"}]
