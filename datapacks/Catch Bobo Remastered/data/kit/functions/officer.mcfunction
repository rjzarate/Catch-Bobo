...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Swapstick","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4,Operation:0,UUID:[I;941097204,1416514812,-1781051719,310661318],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-3.2,Operation:0,UUID:[I;-1481760752,1585925069,-1376131617,-1860209074],Slot:"mainhand"}],HideFlags:7,Tags:["officer","swapstick","meleeDamage","attackSpeed","successfulHitRequirement","damageDealt","successfulHit","successfulHitDuration","successfulHitAttackSpeed","activationRequirement","dogIsAlive","cooldown","actionbarSpecial"],swapstick:1,meleeDamage:4,attackSpeed:80,damageDealt:4,successfulHitDuration:1,successfulHitAttackSpeed:80,cooldown:5,noDrop:1,CustomModelData:1300} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.0 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Clicker","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["officer","clicker","activationRequirement","dogIsAlive","cooldown","actionbarRegular"],cooldown:30} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.1 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Orangutan Cloth","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["officer","orangutanCloth","duration","dogStrength1","activationRequirement","dogIsAlive","nearDog","cooldown","actionbarDuration"],duration:20,dogStrength1:20,cooldown:50} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.2 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Dog Whistle","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["officer","dogWhistle","duration","weakness1","slowness5","dogSpeed","range","activationRequirement","dogIsAlive","cooldown","actionbarDuration"],duration:8,weakness1:8,slowness5:8,dogSpeed:8,range:50,cooldown:100} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.3 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Canine Embryo","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["officer","canineEmbryo","dog","activationRequirement","dogIsDead","cooldownRequirement","cooldown","actionbarRegular"],dogHealth:20,dogArmor:10,dogMeleeDamage:5,dogMovementSpeed:150,cooldown:150} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
