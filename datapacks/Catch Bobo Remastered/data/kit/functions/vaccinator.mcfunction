...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Self-Diagnose","color":"dark_red","bold":true,"italic":false}'},Tags:["vaccinator","selfDiagnose","durationVaries","activationRequirement","cooldown","actionbarSpecial"],durationVaries:10,cooldown:15,noDrop:1,CustomModelData:1520} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.2 from entity @s weapon.mainhand


item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Unstable Concoction","color":"dark_red","bold":true,"italic":false}'},Tags:["vaccinator","unstableConcoction","duration","cooldown","actionbarSpecial"],duration:10,cooldown:20,noDrop:1,CustomModelData:1530} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
