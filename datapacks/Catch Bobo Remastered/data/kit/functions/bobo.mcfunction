...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Jackfruit Jumper","color":"gold","bold":true,"italic":false}'},Enchantments:[{}],Tags:["bobo","jackfruitJumper","jumpBoostX","cooldown","actionbarActive"],CustomModelData:1,cooldown:5,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
