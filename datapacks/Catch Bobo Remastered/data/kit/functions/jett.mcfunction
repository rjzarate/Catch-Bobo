...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Updraft","color":"dark_red","bold":true,"italic":false}'},Tags:["jett","updraft","durationDecimal","levitation15Decimal","ammo","maxAmmo","cooldown","ammoCooldown","actionbarAmmo1Duration"],durationDecimal:85,levitation15Decimal:85,maxAmmo:4,cooldown:25,ammoCooldown:1,noDrop:1,CustomModelData:1207} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
