...
item replace entity @s weapon.mainhand with crossbow{display:{Name:'{"text":"Blade Storm","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2.0,Operation:0,UUID:[I;-148160752,158592069,-137611617,-186029074],Slot:"mainhand"}],Tags:["jett","bladeStorm","rangeDamage","equipTimeDecimal","range","hitsHead","hitsHeadRangeDamageMultiplier","hitsHeadCooldown","hitsHeadTailwindCooldown","hitsLeg","hitsLegRangeDamageMultiplierDecimal","onKill","onKillAmmoGiven","ammo","maxAmmo","cooldown","ammoCooldown","actionbarAmmo"],rangeDamage:2,equipTimeDecimal:5,range:50,hitsHeadRangeDamageMultiplier:3,hitsHeadCooldown:-50,hitsHeadTailwindCooldown:-15,hitsLegRangeDamageMultiplierDecimal:5,onKillAmmoGiven:5,maxAmmo:5,cooldown:100,ammoCooldown:2,ChargedProjectiles:[{id:"minecraft:air",Count:1b},{},{}],Charged:1b,Unbreakable:1b,HideFlags:47,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
