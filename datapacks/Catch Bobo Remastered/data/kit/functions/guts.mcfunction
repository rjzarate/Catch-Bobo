...
scoreboard players operation .chargeDelay repeaterCrossbowStats = .chargeDelay stats
scoreboard players operation .chargeDelay repeaterCrossbowStats *= #20 constant
