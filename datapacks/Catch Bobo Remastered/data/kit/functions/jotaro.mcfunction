...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"ORA!","color":"dark_red","bold":true,"italic":false}'},Tags:["jotaro","ora","duration","damage","fireRate","range","cooldown","actionbarDuration"],CustomModelData:1004,ora:1,duration:5,damage:3,fireRate:500,range:5,cooldown:30,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
