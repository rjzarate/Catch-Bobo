...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Star Finger","color":"dark_red","bold":true,"italic":false}'},Tags:["jotaro","starFinger","rangeDamage","range","wither1","hitsHead","hitsHeadBlindness","cooldown","actionbarRegular"],CustomModelData:1003,starFinger:1,rangeDamage:2,range:10,wither1:4,hitsHeadBlindness:2,cooldown:10,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.2 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"ORA!","color":"dark_red","bold":true,"italic":false}'},Tags:["jotaro","ora","duration","damage","fireRate","range","cooldown","actionbarDuration"],CustomModelData:1004,ora:1,duration:5,damage:3,fireRate:500,range:6,cooldown:20,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
