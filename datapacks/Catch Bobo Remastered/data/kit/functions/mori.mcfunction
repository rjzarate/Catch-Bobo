...
item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Geundoowun","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["mori","geundoowun","duration","size","underTheCloud","othersUnderTheCloud","othersLeavingTheCloud","cooldown","actionbarDuration"],duration:60,size:80,underTheCloudRangeDamage:2,underTheCloudMovementSpeed:25,othersLeavingTheCloudDamage:3,cooldown:90,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.1 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Thunder Breaker","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["mori","thunderBreaker","duration","speed2","cooldown","actionbarDuration"],noDrop:1,duration:15,speed2:15,cooldown:75} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
item replace block 0 0 0 container.2 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand with ender_eye{display:{Name:'{"text":"Noeseon","color":"dark_red","bold":true,"italic":false}'},Enchantments:[{}],Tags:["mori","noeseon","chargeUp","duration","chargeUpRequirement","lightning","cooldown","actionbarSpecial"],chargeUp:10,duration:5,lightningAmount:4,lightningLastGlowing:5,cooldown:100,noDrop:1} 1
item modify entity @s weapon.mainhand kit:description
item modify entity @s weapon.mainhand kit:stats
